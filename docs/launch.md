...
| [OpenAI Plugins Directory submission portal](https://platform.openai.com/plugins) | The [official submission guide](https://developers.openai.com/plugins/deploy/submission) accepts skills-only packages and requires a verified publisher identity, Apps Management write access, public listing/support/privacy/terms information, and at least five positive plus three negative test cases. Submission begins review; approval and publication are separate steps. | Later, after the local CLI dependencies and experimental gateway are clearly documented and reviewers can reproduce the submitted cases. A repository marketplace can distribute the package before a universal directory listing. Do not claim approval or discovery in the public directory without checking it. |
